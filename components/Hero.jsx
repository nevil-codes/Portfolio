...
export default function Hero() {
  return (
    <header className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-16 items-center py-24 md:py-[88px] border-b border-border">
      <div className="flex flex-col gap-6">
        <div className="font-mono text-sm text-amber">{hero.kicker}</div>
        <h1 className="m-0 text-5xl md:text-[60px] font-semibold leading-[1.05] tracking-tight">
          {hero.heading}
        </h1>
        <p className="m-0 text-lg md:text-[19px] leading-relaxed text-muted max-w-[480px]">
          {hero.intro}
        </p>
